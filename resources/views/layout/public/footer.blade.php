                    ...
                    <div class="vamiyi-widget">
                        ...
                        <ul class="vamiyi-list">
                            <li class="vamiyi-list-item">
                                <a href="{{ route('useful-links') }}#about-us" class="vamiyi-list-link scroll-link" data-section="about-us">
                            ...
                            <li class="vamiyi-list-item">
                                <a href="{{ route('useful-links') }}#how-it-works" class="vamiyi-list-link scroll-link" data-section="how-it-works">
                                    <span class="vamiyi-arrow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <line x1="5" y1="12" x2="19" y2="12"></line>
                                            <polyline points="12 5 19 12 12 19"></polyline>
                            ...
                            <li class="vamiyi-list-item">
                                <a href="{{ route('useful-links') }}#faq" class="vamiyi-list-link scroll-link" data-section="faq">
                                    <span class="vamiyi-arrow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <line x1="5" y1="12" x2="19" y2="12"></line>
                                            <polyline points="12 5 19 12 12 19"></polyline>
                            ...
                            <li class="vamiyi-list-item">
                                <a href="{{ route('useful-links') }}#terms" class="vamiyi-list-link scroll-link" data-section="terms">
                                    <span class="vamiyi-arrow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <line x1="5" y1="12" x2="19" y2="12"></line>
                                            <polyline points="12 5 19 12 12 19"></polyline>
                            ...
                            <li class="vamiyi-list-item">
                                <a href="{{ route('useful-links') }}#privacy" class="vamiyi-list-link scroll-link" data-section="privacy">
                                    <span class="vamiyi-arrow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <line x1="5" y1="12" x2="19" y2="12"></line>
                                            <polyline points="12 5 19 12 12 19"></polyline>
                            ...
                            <li class="vamiyi-list-item">
                                <a href="{{ route('useful-links') }}#join-us" class="vamiyi-list-link scroll-link" data-section="join-us">
                                    <span class="vamiyi-arrow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <line x1="5" y1="12" x2="19" y2="12"></line>
                                            <polyline points="12 5 19 12 12 19"></polyline>
                            ...
                            <li class="vamiyi-list-item">
                                <a href="{{ route('useful-links') }}#cookies" class="vamiyi-list-link scroll-link" data-section="cookies">
                                    <span class="vamiyi-arrow">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <line x1="5" y1="12" x2="19" y2="12"></line>
                                            <polyline points="12 5 19 12 12 19"></polyline>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        scrollLinks.forEach(function(link) {
            ...
            link.addEventListener('click', function(e) {
                ...
                const liensUtilesPath = "{{ route('useful-links') }}".split('?')[0]; // Remove any query parameters
                const targetSection = this.getAttribute('data-section');

                console.log('Current path:', currentPath);
                console.log('Liens utiles path:', liensUtilesPath);

                // If we're already on the useful-links page
                if (currentPath === liensUtilesPath || currentPath === liensUtilesPath + '/') {
                    e.preventDefault();
                    console.log('On useful-links page, preventing default');
                    ...
                    console.log('Not on useful-links page, allowing default navigation');
