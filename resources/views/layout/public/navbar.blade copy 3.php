...
<style>
    ...
    @media only screen and (min-width : 993px) {
        ...
        /*  */
        body.home-2 nav.navbar.bootsnav.navbar-transparent ul.nav>li>a.add-annonce-2 {
            fill: #fff !important;
            /* background-color: #005870 !important; */
        }

        body nav.navbar.bootsnav ul.nav>li>a.add-annonce-2 {
            /* background-color: #fff !important; */
                ...
                <li class="btn-deposer-annonce-li no-pd dropdown">
                    ...
                    @else
                        <a data-toggle="modal" data-target="#signin" href="javascript:void(0)" onclick="$('#share').hide()">
                            <img src="{{ asset('assets/img/icons/annonce.png') }}" alt="Déposer une annonce" style="width: 30px; height: 30px;">
                        </a>
                    @endif
                </li>
            </ul>
