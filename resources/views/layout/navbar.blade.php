    ...
    <div class="col-md-6">
        <div class="containelr" style="margin-left: 5px; margin-right: 0px !important;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:void(0)"><img src="{{ asset('assets/img/logo-vamiyi-by-numrod.png') }}" height="100%" xd alt=""></a>
            </div>
        </div>
    </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="log-off.html"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
