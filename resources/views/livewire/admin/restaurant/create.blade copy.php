        ...
        <form wire:submit.prevent="store">
            <div class="container text-left">
                <div class="row align-items-start">
                    <div class="col entreprise">
                        ...
                        <div class="form-group">
                            <div>
                                <button class="btn btn-form" data-bs-toggle="offcanvas" data-bs-target="#entreprise"
                                    type="button" aria-controls="entreprise-1">Mon établissement<i
                                        class="fa fa-pencil"></i></button>
                            </div>
                        </div>
                        <div class="offcanvas offcanvas-end" id="entreprise" data-bs-scroll="true"
                            aria-labelledby="entreprise" tabindex="-1">
                            ...
                            <div class="offcanvas-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="longitude" type="number"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        <label for="horaire">Tableau des horaires à intégrer une fois le code
                                            prêt</label>
                    ...
                    <div class="col entrees">
                        ...
                        <div id="entrees-container">
                            ...
                            <div class="form-group entree-item" id="entree-item-1">
                                <div>
                                    <button class="btn btn-form" data-bs-toggle="offcanvas" data-bs-target="#entree-1"
                                        type="button" aria-controls="entree-1">
                                        Entrée 1 <i class="fa fa-pencil"></i>
                                    </button>
                                </div>
                                <div class="offcanvas offcanvas-end" id="entree-1" data-bs-scroll="true"
                                    aria-labelledby="entree-1" tabindex="-1">
                                    <div class="offcanvas-header">
                                        <h5 class="offcanvas-title">Entrée 1</h5>
                                        <button class="btn-close text-reset" id="entrees-close-1"
                                            data-bs-dismiss="offcanvas" type="button" aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body">
                                        <div class="form-group">
                                            <label for="entree-name-1">Nom<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="entree-name-1"
                                                data-entree-id="1" type="text">
                                        </div>
                                        <div class="form-group">
                                            <label for="entree-description-1">Ingrédients<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <textarea class="form-control required-field" id="entree-description-1"
                                                data-entree-id="1" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="entree-price-1">Prix<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="entree-price-1"
                                                data-entree-id="1" type="number">
                                        </div>
                                        <div class="form-group">
                                            <label for="form-img-1">Image à la Une</label>
                                            <input class="form-control-file" id="form-img-entree-1" data-entree-id="1"
                                                type="file">
                                        </div>
                                        <button class="btn btn-success mb-2 save-entree-btn" data-entree-id="1"
                                            type="button">Enregistrer</button>
                                        <button class="btn btn-danger mb-2 delete-entree-btn" data-entree-id="1"
                    ...
                    <div class="col plats">
                        ...
                        <div id="plats-container">
                            ...
                            <div class="form-group plat-item" id="plat-item-1">
                                <div>
                                    <button class="btn btn-form" data-bs-toggle="offcanvas" data-bs-target="#plat-1"
                                        type="button" aria-controls="plat-1">
                                        Plat 1 <i class="fa fa-pencil"></i>
                                    </button>
                                </div>
                                <div class="offcanvas offcanvas-end" id="plat-1" data-bs-scroll="true"
                                    aria-labelledby="plat-1" tabindex="-1">
                                    <div class="offcanvas-header">
                                        <h5 class="offcanvas-title">Plat 1</h5>
                                        <button class="btn-close text-reset" id="plats-close-1"
                                            data-bs-dismiss="offcanvas" type="button" aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body">
                                        <div class="form-group">
                                            <label for="plat-name-1">Nom<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="plat-name-1" data-plat-id="1"
                                                type="text">
                                        </div>
                                        <div class="form-group">
                                            <label for="plat-description-1">Ingrédients<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <textarea class="form-control required-field" id="plat-description-1"
                                                data-plat-id="1" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="plat-price-1">Prix<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="plat-price-1"
                                                data-plat-id="1" type="number">
                                        </div>
                                        <div class="form-group">
                                            <label for="form-img-plat-1">Image à la Une</label>
                                            <input class="form-control-file" id="form-img-plat-1" data-plat-id="1"
                                                type="file">
                                        </div>
                                        <button class="btn btn-success mb-2 save-plat-btn" data-plat-id="1"
                                            type="button">Enregistrer</button>
                                        <button class="btn btn-danger mb-2 delete-plat-btn" data-plat-id="1"
                                            type="button">Supprimer</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col desserts">
                        ...
                        <div id="desserts-container">
                            ...
                            <div class="form-group dessert-item" id="dessert-item-1">
                                <div>
                                    <button class="btn btn-form" data-bs-toggle="offcanvas" data-bs-target="#dessert-1"
                                        type="button" aria-controls="dessert-1">
                                        Dessert 1 <i class="fa fa-pencil"></i>
                                    </button>
                                </div>
                                <div class="offcanvas offcanvas-end" id="dessert-1" data-bs-scroll="true"
                                    aria-labelledby="dessert-1" tabindex="-1">
                                    <div class="offcanvas-header">
                                        <h5 class="offcanvas-title">Dessert 1</h5>
                                        <button class="btn-close text-reset" id="desserts-close-1"
                                            data-bs-dismiss="offcanvas" type="button" aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body">
                                        <div class="form-group">
                                            <label for="dessert-name-1">Nom<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="dessert-name-1"
                                                data-dessert-id="1" type="text">
                                        </div>
                                        <div class="form-group">
                                            <label for="dessert-description-1">Ingrédients<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <textarea class="form-control required-field" id="dessert-description-1"
                                                data-dessert-id="1" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="dessert-price-1">Prix<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="dessert-price-1"
                                                data-dessert-id="1" type="number">
                                        </div>
                                        <div class="form-group">
                                            <label for="form-img-dessert-1">Image à la Une</label>
                                            <input class="form-control-file" id="form-img-dessert-1" data-dessert-id="1"
                                                type="file">
                                        </div>
                                        <button class="btn btn-success mb-2 save-dessert-btn" data-dessert-id="1"
                                            type="button">Enregistrer</button>
                                        <button class="btn btn-danger mb-2 delete-dessert-btn" data-dessert-id="1"
                                            type="button">Supprimer</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row align-items-end">
                    ...
                    <button class="btn btn-success mb-2" id="restaurant-form-submit" type="submit"
                        wire:target='store'>Sauvegarder l'annonce</button>
                </div>
            </div>
        </form>
    </div>
