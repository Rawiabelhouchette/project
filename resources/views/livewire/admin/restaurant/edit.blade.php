                                    ...
                                    <div class="offcanvas-body">
                                        ...
                                        <div class="form-group">
                                            <label for="entree-price-{{ $index + 1 }}">Prix<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="entree-price-{{ $index + 1 }}"
                                                type="number" wire:model="entrees.{{ $index }}.prix_min">
                                        </div>
                                        <div class="form-group">
                                            <label for="form-img-entree-{{ $index + 1 }}">Image à la Une <b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control form-control-file"
                                                id="form-img-entree-{{ $index + 1 }}" data-id="{{ $index + 1 }}" type="file"
                                                wire:model="entrees.{{ $index }}.image" accept="image/*">
                                    ...
                                    <div class="offcanvas-body">
                                        ...
                                        <div class="form-group">
                                            <label for="form-img-plat-{{ $index + 1 }}">Image à la Une <b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control form-control-file"
                                                id="form-img-plat-{{ $index + 1 }}" data-id="{{ $index + 1 }}" type="file"
                                                wire:model="plats.{{ $index }}.image" accept="image/*">
                                        ...
                                        <button class="btn btn-danger mb-2 delete-plat-btn" data-plat-id="{{ $index + 1 }}"
                                            type="button" wire:click="removePlat({{ $index }})">Supprimer</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                                    ...
                                    <div class="offcanvas-body">
                                        <div class="form-group">
                                            <label for="dessert-name-{{ $index + 1 }}">Nom<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="dessert-name-{{ $index + 1 }}"
                                                type="text" wire:model="desserts.{{ $index }}.nom">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="dessert-price-{{ $index + 1 }}">Prix<b
                                                    style="color: red; font-size: 100%;">*</b></label>
                                            <input class="form-control required-field" id="dessert-price-{{ $index + 1 }}"
                                                type="number" wire:model="desserts.{{ $index }}.prix_min">
                                        </div>
                                        <div class="form-group">
