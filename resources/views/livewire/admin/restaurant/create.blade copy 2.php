                                ...
                                <div class="offcanvas offcanvas-end" id="plat-1" data-bs-scroll="true" aria-labelledby="plat-1" tabindex="-1">
                                    ...
                                    <div class="offcanvas-body">
                                        <form>
                                            <div class="form-group">
                                                <label for="name-1">Nom</label>
                                                <input class="form-control" id="name-1" type="text" value="Nom du plat 1">
                                            </div>
                                            <div class="form-group">
                                                <label for="description-1">Ingrédients</label>
                                                <textarea class="form-control" id="description-1" rows="3">Ingrédients du plat 1</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="price-1">Prix</label>
                                                <input class="form-control" id="price-1" type="text" value="15.00">
                                            </div>
                                            <div class="form-group">
                                                <label for="form-img-1">Image à la Une</label>
                                                <input class="form-control-file" id="form-img-1" type="file">
