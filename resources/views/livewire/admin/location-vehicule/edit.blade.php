                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xl-3" style="margin-top: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="number" class="form-control" placeholder="" wire:model.defer='nombre_places' required>
                                @error('nombre_places')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xl-3" style="margin-top: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="number" class="form-control" placeholder="" wire:model.defer='nombre_portes' required>
                                @error('nombre_portes')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xl-3" style="margin-top: 15px;" wire:ignore>
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <label class="" for="boite_vitesse">Boite de vitesses
                                    <b style="color: red; font-size: 100%;">*</b>
                                </label> <br>
                                <select id="boite_vitesse" class="select2" wire:model.defer='boite_vitesse' required data-nom="boite_vitesse">
                                    <option value="">-- Sélectionner --</option>
