							...
							<form>
								<div class="row mrg-r-10 mrg-l-10">
    								...
    								<div class="col-sm-12 padd-top-25">
                                        @if ($isEdit)
                                            <button wire:click='resetForm' class="btn" style="margin-right: 15px;">
                                                <i class="fa fa-cancel fa-lg" style="margin-right: 10px;"></i> Annuler
                                            </button>
                                        @endif
                                        <button wire:target='store' wire:loading.attr='disabled' type="submit" class="btn theme-btn btnAdd" style="margin-right: 15px;">
