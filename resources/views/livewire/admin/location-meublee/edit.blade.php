            ...
            <form wire:submit="update()">
                    ...
                    <div class="col-md-3 col-sm-4 col-xl-3" style="margin-top: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="number" class="form-control" placeholder="" wire:model.defer='nombre_salles_bain' required>
                            </div>
                            <div class="col-md-1"></div>
                        </div>
                    </div>
                ...
                <div class="row" wire:ignore>
                    <div class="col-md-12" style="margin-top: 10px; padding-bottom: 10px; padding-left: 40px;padding-right: 40px;">
                        ...
                        <select class="form-control select2" multiple style="width: 100%;" wire:model.defer='equipements_salle_bain' data-nom="equipements_salle_bain" required>
