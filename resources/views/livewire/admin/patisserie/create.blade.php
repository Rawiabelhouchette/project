                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xl-3" style="margin-top: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input class="form-control" type="text" placeholder="" wire:model.defer='ingredients'>
                                @error('ingredients')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xl-3" style="margin-top: 15px;">
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <label class="">Accompagnement
                                    {{-- <b style="color: red; font-size: 100%;">*</b> --}}
                                </label> <br>
                                <input class="form-control" type="text" placeholder="" wire:model.defer='accompagnement'>
                    ...
                    <div class="col-md-3 col-sm-4 col-xl-3" style="margin-top: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input class="form-control" type="number" value="0" wire:model.defer='prix_min' min="0">
                                @error('prix_min')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xl-3" style="margin-top: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input class="form-control" type="number" value="0" placeholder="" wire:model.defer='prix_max' min="{{ $this->prix_max }}">
                                @error('prix_max')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
