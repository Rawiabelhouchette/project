            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="package-box">
                    ...
                    <div class="package-price" style="">
                        <h3 class="mrg-top-0"
                            style="font-family: 'Poppins', sans-serif; font-size: 27px !important; color: #26354e; margin-bottom: .25em; ">
                            {{ number_format($offre->prix, 0, ',', ' ') }} <sup style="font-size: 15px;">F CFA </sup><sub>/
                                {{ $offre->duree }} Mois</sub></h3>
                    </div>
                ...
                <div class="p-3">
                    ...
                    <form action="{{ route('abonnements.payement.check') }}" method="POST">
                        ...
                        <div class="row p-2 px-4">
                            ...
                            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 mb-4">
                                <div class="input-group mb-2">
                                    ...
                                    <input id="phone" class="form-control" type="text"
                                        placeholder="Numéro de téléphone" required name="numero_telephone"
                                        value="{{ old('numero_telephone') }}" pattern="^[0-9\s]+$"
                                        title="Veuillez entrer uniquement des chiffres et des espaces.">
                                </div>
                            ...
                            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 mb-4">
                                <div class="input-group mb-2">
                                    <span class="input-group-addon"><i class="fa-brands fa-whatsapp theme-cl"
                                            style="font-size: 17px;"></i></span>
                                    <span class="input-group-addon phone_indicatif">+00</i></span>
                                    <input id="whatsapp_phone" class="form-control" type="text"
                                        placeholder="Numéro whatsapp" required name="numero_whatsapp"
                                        value="{{ old('numero_whatsapp') }}" pattern="^[0-9\s]+$"
                                        title="Veuillez entrer uniquement des chiffres et des espaces.">
                                </div>
