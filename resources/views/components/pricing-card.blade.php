...
<div class="col-md-4 col-sm-6 col-xs-12">
    <div class="amiyi-pricing-card">
        ...
        <div class="amiyi-price-section">
            ...
            <div class="amiyi-duration">{{ $offre->duree }} Mois</div>
        </div>

        <!-- Features List -->
        <div class="amiyi-features-list">
            <div class="amiyi-feature">
                <!-- Arrow icon instead of check -->
                ...
                <span class="amiyi-feature-text">3 Designs</span>
            </div>
            <div class="amiyi-feature">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" class="amiyi-feature-icon">
                    <path d="M16.172 11L10.808 5.636L12.222 4.222L20 12L12.222 19.778L10.808 18.364L16.172 13H4V11H16.172Z" fill="currentColor"/>
                </svg>
                <span class="amiyi-feature-text">3 PSD Designs</span>
            </div>
            <div class="amiyi-feature">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" class="amiyi-feature-icon">
                    <path d="M16.172 11L10.808 5.636L12.222 4.222L20 12L12.222 19.778L10.808 18.364L16.172 13H4V11H16.172Z" fill="currentColor"/>
                </svg>
                <span class="amiyi-feature-text">4 color Option</span>
            </div>
            <div class="amiyi-feature">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" class="amiyi-feature-icon">
                    <path d="M16.172 11L10.808 5.636L12.222 4.222L20 12L12.222 19.778L10.808 18.364L16.172 13H4V11H16.172Z" fill="currentColor"/>
                </svg>
                <span class="amiyi-feature-text">10GB Disk Space</span>
            </div>
            <div class="amiyi-feature">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" class="amiyi-feature-icon">
                    <path d="M16.172 11L10.808 5.636L12.222 4.222L20 12L12.222 19.778L10.808 18.364L16.172 13H4V11H16.172Z" fill="currentColor"/>
                </svg>
                <span class="amiyi-feature-text">Full Support</span>
            </div>
        </div>
...
/* Header Styles */
.amiyi-card-header {
    background: #1e2530; /* Original dark background */
    color: #fff;
    text-align: center;
    padding: 30px 20px;
    position: relative;
    clip-path: polygon(0 0, 100% 0, 100% 85%, 50% 100%, 0 85%); /* Shaped bottom edge */
    min-height: 160px;
    display: flex;
    flex-direction: column;
...
.amiyi-icon-wrapper {
    background-color: rgba(245, 166, 35, 0.2); /* Orange with opacity */
    width: 60px;
    height: 60px;
    border-radius: 50%;
    display: flex;
...
.amiyi-icon {
    color: #f5a623; /* Original orange color */
...
.amiyi-duration {
    background: #f5a623; /* Original orange color */
    color: white;
    font-size: 14px;
    font-weight: 600;
    padding: 5px 15px;
...
.amiyi-subscribe-button:hover {
    background: #e69819; /* Darker orange on hover */
