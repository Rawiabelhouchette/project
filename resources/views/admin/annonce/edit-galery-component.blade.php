            ...
            <div class="text-center gallery-box">
                @foreach ($old_galerie as $index => $image)
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="javascript:void(0)" class="theme-cl" wire:click='removeImage("old_galerie", "{{ $image->id }}")'
                ...
                @foreach ($galerie as $index => $image)
                    <div class="col-md-3">
                        ...
                        <a href="javascript:void(0)" class="theme-cl" wire:click='removeImage("galerie", "{{ $index}}")'
                           style="font-weight: bold; font-size: 20px;">x</a>
                    </div>
                @endforeach
            </div>
