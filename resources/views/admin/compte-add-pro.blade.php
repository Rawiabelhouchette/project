    ...
    <div class="row bg-title" style="padding-top: 20px;">
        <div class="col-lg-6 col-md-10 col-sm-6 col-xs-12">
            <ol class="breadcrumb" style="text-align: left;">
                ...
                <li class="active">Ajouter un professionnel</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <div class="col-md-12 col-sm-12" style="margin-bottom: 0px;">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Créer un compte professionnel</h4>
                    </div>

                    <div class="card-body">
                        <br>
                        <form class="form-horizontal" action="{{ route('professionnels.store') }}" method="post">
                            @csrf
                            <div class="row">
                                {{-- Nom --}}
...
@section('js')
    <script src="{{ asset('custom/js/compte-add-pro.js') }}"></script>
@endsection
