...
class Edit extends Component
{
    ...
    public function mount($auberge)
    {
        ...
        $this->date_validite = $auberge->annonce->date_validite;

        $this->types_lit = $auberge->annonce->references->where('slug', 'types-de-lit')->pluck('id')->toArray();
        $this->commodites = $auberge->annonce->references->where('slug', 'commodites-hebergement')->pluck('id')->toArray();
        $this->services = $auberge->annonce->references->where('slug', 'services')->pluck('id')->toArray();
        $this->equipements_herbegement = $auberge->annonce->references->where('slug', 'equipements-hebergement')->pluck('id')->toArray();
        $this->equipements_salle_bain = $auberge->annonce->references->where('slug', 'equipements-salle-de-bain')->pluck('id')->toArray();
        $this->equipements_cuisine = $auberge->annonce->references->where('slug', 'equipements-cuisine')->pluck('id')->toArray();
    }
